class Cell():
    ...
    def color(self):
        if self.wall:
            ...
            ratio = sum(self.resources) / (self.world.max_res_amount *
                                           self.world.res_count)
    ...
    def load(self, data):
        if data == 'X':
            ...
            self.wall = False
            self.resources = [
                self.world.max_res_amount for _ in range(self.world.res_count)
            ]
    ...
    def update(self):
        for i in range(self.world.res_count):
            ...
            # normalize
            self.resources[i] = min(self.resources[i],
                                    self.world.max_res_amount)
